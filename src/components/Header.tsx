			...
			{isOpen && (
				...
				>
					<div className="relative w-full h-full z-30 flex flex-col">
						<div className="flex flex-row justify-between items-center w-full px-4 sm:px-0">
							...
							>
								...
								>
									...
									<svg className="w-4 h-4 sm:hidden" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
							...
							<div className="flex flex-row items-center gap-4 md:gap-6 text-white/80 text-sm font-link uppercase tracking-[0.16em]">
								<button
						...
						<ul className="flex flex-col items-center justify-center flex-grow font-link text-5xl md:text-6xl lg:text-8xl" role="menu" aria-label="Main navigation">
							<MenuItem
								itemsArr={workArr}
								link="WORK"
								href="/work"
						...
						<div className="flex flex-row justify-between items-center px-4 md:px-10 pb-10 text-white/80 text-sm font-cabinet">
							<div
							...
							>
								...
								<p className="text-white/80">Based in OKC · Remote</p>
							</div>
						</div>
					</div>
				</div>
